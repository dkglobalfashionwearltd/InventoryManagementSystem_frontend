...
export type ComboboxOption = {
  departmentId: number;
  name: string;
  status?: string; // optional subtitle
  [k: string]: any;
};
        ...
        <input
          ...
          aria-activedescendant={
            highlightedIndex >= 0 && filtered[highlightedIndex]
              ? `cb-item-${id}-${filtered[highlightedIndex].departmentId}`
              : undefined
          }
          className={
              ...
              filtered.map((opt, idx) => {
                ...
                return (
                  <li
                    ...
                    id={`cb-item-${id}-${opt.departmentId}`}
                    role="option"
                    aria-selected={value?.departmentId === opt.departmentId}
                  ...
                  >
                    ...
                    {value?.departmentId === opt.departmentId && (
                      <svg
                        className="h-4 w-4"
                        viewBox="0 0 20 20"
                        fill="none"
